...
public:
	...
	mix_ch_t senderIndex() const { return m_from->m_channelIndex; }

	mix_ch_t receiverIndex() const { return m_to->m_channelIndex; }

	FloatModel* amount() { return &m_amount; }

	MixerChannel* sender() const { return m_from; }

	MixerChannel* receiver() const { return m_to; }
...
public:
	...
	QString nodeName() const override { return "mixer"; }

	MixerChannel* mixerChannel(int _ch) { return m_mixerChannels[_ch]; }
	...
	inline mix_ch_t numChannels() const { return m_mixerChannels.size(); }
