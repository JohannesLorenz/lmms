...
public:
	...
	inline const bool enabled() { return m_isEnabled; }

	inline const bool isOutput() { return m_isOutput; }

	inline void setOutput(bool state = true) { m_isOutput = state; }

	inline void setEnabled(bool state = true) { m_isEnabled = state; }

	inline void setGroupName(QString groupName) { m_groupName = groupName; }

	inline void setGroupId(uint8_t groupId) { m_groupId = groupId; }

	virtual QString groupName() const { return m_groupName; }

	virtual uint8_t groupId() const { return m_groupId; }
