	...
	, m_moveXOff(0)
{
	...
	if (s_posMarkerPixmap == nullptr) { s_posMarkerPixmap = new QPixmap(embed::getIconPixmap("playpos_marker")); }
...
void TimeLineWidget::mouseMoveEvent(QMouseEvent* event)
{
	...
	case SelectSongClip: emit regionSelectedFromPixels(m_initalXSelect, event->x()); break;
