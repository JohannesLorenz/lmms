...
// Prevent dangling separator at end of menu per https://bugreports.qt.io/browse/QTBUG-40071
	...
	ToolButton* pattern_editor_window = new ToolButton(embed::getIconPixmap("pattern_track_btn"),
	...
	ToolButton* microtuner_window = new ToolButton(embed::getIconPixmap("microtuner"),
...
void MainWindow::togglePatternEditorWin(bool forceShow) { toggleWindow(getGUI()->patternEditor(), forceShow); }

void MainWindow::toggleSongEditorWin() { toggleWindow(getGUI()->songEditor()); }

void MainWindow::toggleProjectNotesWin() { toggleWindow(getGUI()->getProjectNotes()); }

void MainWindow::togglePianoRollWin() { toggleWindow(getGUI()->pianoRoll()); }

void MainWindow::toggleAutomationEditorWin() { toggleWindow(getGUI()->automationEditor()); }

void MainWindow::toggleMixerWin() { toggleWindow(getGUI()->mixerView()); }
...
void MainWindow::updateViewMenu()
{
	...
	m_viewMenu->addAction(
		embed::getIconPixmap("pattern_track"), tr("Pattern Editor") + "\tCtrl+2", this, SLOT(togglePatternEditorWin()));
	m_viewMenu->addAction(
	...
	m_viewMenu->addAction(embed::getIconPixmap("mixer"), tr("Mixer") + "\tCtrl+5", this, SLOT(toggleMixerWin()));
	m_viewMenu->addAction(
	...
	m_viewMenu->addAction(
		embed::getIconPixmap("microtuner"), tr("Microtuner") + "\tCtrl+8", this, SLOT(toggleMicrotunerWin()));
...
void MainWindow::onToggleMetronome() { Engine::audioEngine()->setMetronomeActive(m_metronomeToggle->isChecked()); }
...
void MainWindow::updatePlayPauseIcons()
{
	...
	if (Engine::getSong()->isPlaying())
	{
		...
		case Song::Mode_PlayPattern: getGUI()->patternEditor()->setPauseIcon(true); break;

		case Song::Mode_PlayMidiClip: getGUI()->pianoRoll()->setPauseIcon(true); break;
