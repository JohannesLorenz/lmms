...
void MixerLine::paintEvent(QPaintEvent*) {
	...
	bool receiveFromThis
		= Engine::mixer()->channelSendModel(m_channelIndex, m_mv->currentMixerLine()->m_channelIndex) != nullptr;
	QPainter painter;
	painter.begin(this);
...
void MixerLine::mousePressEvent(QMouseEvent*) { m_mv->setCurrentMixerLine(this); }
...
QBrush MixerLine::backgroundActive() const { return m_backgroundActive; }

void MixerLine::setBackgroundActive(const QBrush& c) { m_backgroundActive = c; }

QColor MixerLine::strokeOuterActive() const { return m_strokeOuterActive; }

void MixerLine::setStrokeOuterActive(const QColor& c) { m_strokeOuterActive = c; }

QColor MixerLine::strokeOuterInactive() const { return m_strokeOuterInactive; }

void MixerLine::setStrokeOuterInactive(const QColor& c) { m_strokeOuterInactive = c; }

QColor MixerLine::strokeInnerActive() const { return m_strokeInnerActive; }

void MixerLine::setStrokeInnerActive(const QColor& c) { m_strokeInnerActive = c; }

QColor MixerLine::strokeInnerInactive() const { return m_strokeInnerInactive; }
