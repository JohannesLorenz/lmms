	...
	, m_pressed(false)
{
	...
	if (s_arrow == nullptr) { s_arrow = new QPixmap(embed::getIconPixmap("combobox_arrow")); }

	if (s_arrowSelected == nullptr) { s_arrowSelected = new QPixmap(embed::getIconPixmap("combobox_arrow_selected")); }
